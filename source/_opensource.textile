...
!images/nanomsg.png!
"*nanomsg*":https://bitbucket.org/kschiess/nanomsg Ruby bindings for the `nanomsg` library. "nanomsg":http://nanomsg.org/ library is a high-performance implementation of several "scalability protocols". This Ruby binding allows you to create work distribution topologies and do safe IPC, across threads or the network. 

!images/placeholder.png!
"*qemu-toolkit*":http://kschiess.bitbucket.org/qemu-toolkit/README.7.html 
drastically simplifies running VMs on "Illumos":http://blog.illumos.org/about-illumos-2/ distributions. 
It allows deploying VMs in several architectural variants and has full 
scripting support. See the extensive man pages behind the link. 
