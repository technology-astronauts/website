...
*You can rely on us* If we can do it, we will. If we don't think we're the
perfect choice, we will tell you and suggest an alternative. If something
is not possible, we will suggest alternatives.
